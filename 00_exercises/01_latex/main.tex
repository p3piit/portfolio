...
$f(x) = \frac{1}{\sigma\sqrt{2\pi}}exp(-\frac{1}{2}\frac{(x-\mu)^2}{\sigma^2})$
...
\begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=0.75\linewidth]{mlarpis1.png}
        \caption{ Histogram}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=0.75\linewidth]{mlarpis2.png}
        \caption{ Densityplot}
    \end{subfigure}
    \vspace{0.5cm}
        \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=0.75\linewidth]{mlarpis3.png}
        \caption{ Stripplot}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=0.75\linewidth]{mlarpis4.png}
        \caption{ Boxplot}
    \end{subfigure}
